...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$hesstun_description = get_bloginfo( 'description', 'display' );
			if ( $hesstun_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $hesstun_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
